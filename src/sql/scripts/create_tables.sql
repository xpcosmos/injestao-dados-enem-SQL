...
CREATE TABLE IF NOT EXISTS enem2020.PROVAS(
    FK_ID_PARTICIPANTE BIGINT,
    ANO_ENEM INT,
    PRESENCA_CIENCIA_NATURAL INT,
    PRESENCA_CIENCIA_HUMANAS INT,
    PRESENCA_LINGUAGENS INT,
    PRESENCA_MATEMATICA INT,
    COD_CIENCIA_NATURAL INT,
    COD_CIENCIA_HUMANAS INT,
    COD_LINGUAGENS INT,
    COD_MATEMATICA INT,
...
CREATE TABLE IF NOT EXISTS enem2020.SOCIOECONOMICOS(
    FK_ID_PARTICIPANTE BIGINT NOT NULL,
    Q1 VARCHAR(2),
    Q2 VARCHAR(2),
    Q3 VARCHAR(2),
    Q4 VARCHAR(2),
