...
CREATE TABLE IF NOT EXISTS enem2020.escolas(
    PK_ID_ESCOLA INT NOT NULL PRIMARY KEY,
    MUNICIPIO VARCHAR(150) NOT NULL,
    FK_COD_UF_ESCOLA INT NOT NULL, 
...
CREATE TABLE IF NOT EXISTS enem2020.PARTICIPANTE(
    ...
    FK_ID_ESCOLA_ENSINO_MEDIO INT NOT NULL,
    FK_COD_UF_PARTICIPANTE INT NOT NULL,
    FAIXA_ETARIA INT NOT NULL,
    SEXO INT NOT NULL,
    ESTADO_CIVIL INT NOT NULL,
    RACA_COR INT NOT NULL, 
    NACIONALIDADE INT NOT NULL,
    CONCLUSAO_ENSINO_MEDIO INT NOT NULL,
